    ...
    internal class Program
    {
            ...
            do
            {
                ...
                switch (choice)
                {
                    case "1":
                        ...
                        //Car[] filteredCars = FilterByMillage(cars, minMillage, maxMillage);
        ...
        static int GetInputInt(string name, int min, int max = int.MaxValue)
        {
            ...
            do
            {
                ...
                isNum = int.TryParse(inputStr, out input); //asdasd
        ...
        static double GetInputDouble(string name, double min, double max = double.MaxValue)
        {
            ...
            do
            {
                Console.WriteLine(name);
                string inputStr = Console.ReadLine();
                isNum = double.TryParse(inputStr, out input); //asdasd
            } while (!isNum || input < min || input > max);
